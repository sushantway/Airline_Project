...
var url_updateUserDetails = 'http://localhost:8080/ARS/api/user/'+user_detail_userId;     	
    	//var data;
      ...
      //    alert(JSON.stringify(user_Details));
    			...
    			$http.post('http://localhost:8080/ARS/api/user/register/edit',user_Details).then(
